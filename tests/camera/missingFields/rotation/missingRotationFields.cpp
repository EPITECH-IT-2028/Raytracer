...
TEST_F(ParserConfigFileTest, MissingCameraRotationFields) {
  _cfgFile = "tests/camera/missingFields/rotation/missingX.cfg";
   ...
   * _cfgFile = "tests/camera/missingFields/rotation/missingZ.cfg";
