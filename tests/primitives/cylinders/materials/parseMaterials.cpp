...
TEST_F(ParserConfigFileTest, ParseCylindersMaterials) {
  _cfgFile = "tests/primitives/cylinders/materials/reflective.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/materials/refractive.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/materials/transparent.cfg";
...
TEST_F(ParserConfigFileTest, ParseInvalidCylindersMaterial) {
  _cfgFile = "tests/primitives/cylinders/materials/invalid.cfg";
  Raytracer::ParserConfigFile parser(_cfgFile, _plugins);
  Raytracer::Camera camera;
  Raytracer::ShapeComposite sc;
  Raytracer::LightComposite lc;
