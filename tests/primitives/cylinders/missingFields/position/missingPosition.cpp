...
TEST_F(ParserConfigFileTest, MissingCylindersPositionFields) {
  _cfgFile = "tests/primitives/cylinders/missingFields/position/missingX.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/position/missingY.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/position/missingZ.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/position/missingR.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/position/missingH.cfg";
