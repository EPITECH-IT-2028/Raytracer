...
TEST_F(ParserConfigFileTest, MissingCylindersColorFields) {
  _cfgFile = "tests/primitives/cylinders/missingFields/color/missingColor.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/color/missingColorR.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/color/missingColorG.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/missingFields/color/missingColorB.cfg";
