...
TEST_F(ParserConfigFileTest, InvalidCylindersPositionFields) {
  _cfgFile = "tests/primitives/cylinders/invalidFields/position/invalidX.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/position/invalidY.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/position/invalidZ.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/position/invalidR.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/position/invalidH.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/position/negativeR.cfg";
