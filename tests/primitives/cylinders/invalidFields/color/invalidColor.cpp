...
TEST_F(ParserConfigFileTest, InvalidCylindersColorFields) {
  _cfgFile = "tests/primitives/cylinders/invalidFields/color/invalidColorR.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/color/invalidColorG.cfg";
  ...
  _cfgFile = "tests/primitives/cylinders/invalidFields/color/invalidColorB.cfg";
