...
TEST_F(ParserConfigFileTest, ParseConesInfMaterials) {
  _cfgFile = "tests/primitives/infiniteCones/materials/reflective.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/materials/refractive.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/materials/transparent.cfg";
...
TEST_F(ParserConfigFileTest, ParseInvalidConesInfMaterial) {
  _cfgFile = "tests/primitives/infiniteCones/materials/invalid.cfg";
  Raytracer::ParserConfigFile parser(_cfgFile, _plugins);
  Raytracer::Camera camera;
  Raytracer::ShapeComposite sc;
  Raytracer::LightComposite lc;
