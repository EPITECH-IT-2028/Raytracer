...
TEST_F(ParserConfigFileTest, InvalidInfiniteConesColorFields) {
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/color/invalidColorR.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/color/invalidColorG.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/color/invalidColorB.cfg";
