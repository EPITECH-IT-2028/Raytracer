...
TEST_F(ParserConfigFileTest, InvalidInfiniteConesPositionFields) {
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/position/invalidX.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/position/invalidY.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/position/invalidZ.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/position/invalidA.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/invalidFields/position/negativeA.cfg";
