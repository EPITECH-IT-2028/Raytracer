...
TEST_F(ParserConfigFileTest, MissingInfiniteConesPositionFields) {
  _cfgFile = "tests/primitives/infiniteCones/missingFields/position/missingX.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/missingFields/position/missingY.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/missingFields/position/missingZ.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCones/missingFields/position/missingA.cfg";
