...
TEST_F(ParserConfigFileTest, ParseSphereMaterials) {
  _cfgFile = "tests/primitives/spheres/materials/reflective.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/materials/refractive.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/materials/transparent.cfg";
...
TEST_F(ParserConfigFileTest, ParseInvalidSphereMaterial) {
  _cfgFile = "tests/primitives/spheres/materials/invalid.cfg";
  Raytracer::ParserConfigFile parser(_cfgFile, _plugins);
  Raytracer::Camera camera;
  Raytracer::ShapeComposite sc;
  Raytracer::LightComposite lc;
