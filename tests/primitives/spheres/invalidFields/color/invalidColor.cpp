...
TEST_F(ParserConfigFileTest, InvalidSpheresColorFields) {
  _cfgFile = "tests/primitives/spheres/invalidFields/color/invalidColorR.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/invalidFields/color/invalidColorG.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/invalidFields/color/invalidColorB.cfg";
