...
TEST_F(ParserConfigFileTest, InvalidSpheresPositionFields) {
  _cfgFile = "tests/primitives/spheres/invalidFields/position/invalidX.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/invalidFields/position/invalidY.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/invalidFields/position/invalidZ.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/invalidFields/position/invalidR.cfg";
