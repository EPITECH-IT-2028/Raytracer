...
TEST_F(ParserConfigFileTest, MissingSpheresPositionFields) {
  _cfgFile = "tests/primitives/spheres/missingFields/position/missingX.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/missingFields/position/missingY.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/missingFields/position/missingZ.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/missingFields/position/missingR.cfg";
