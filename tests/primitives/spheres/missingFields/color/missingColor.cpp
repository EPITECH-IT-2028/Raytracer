...
TEST_F(ParserConfigFileTest, MissingSpheresColorFields) {
  _cfgFile = "tests/primitives/spheres/missingFields/color/missingColor.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/missingFields/color/missingColorR.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/missingFields/color/missingColorG.cfg";
  ...
  _cfgFile = "tests/primitives/spheres/missingFields/color/missingColorB.cfg";
