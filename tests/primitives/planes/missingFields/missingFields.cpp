...
TEST_F(ParserConfigFileTest, MissingPlanesFields) {
  _cfgFile = "tests/primitives/planes/missingFields/missingNormal.cfg";
  ...
  _cfgFile = "tests/primitives/planes/missingFields/missingOffset.cfg";
