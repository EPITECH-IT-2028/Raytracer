...
TEST_F(ParserConfigFileTest, MissingPlanesColorFields) {
  _cfgFile = "tests/primitives/planes/missingFields/color/missingColor.cfg";
  ...
  _cfgFile = "tests/primitives/planes/missingFields/color/missingColorR.cfg";
  ...
  _cfgFile = "tests/primitives/planes/missingFields/color/missingColorG.cfg";
  ...
  _cfgFile = "tests/primitives/planes/missingFields/color/missingColorB.cfg";
