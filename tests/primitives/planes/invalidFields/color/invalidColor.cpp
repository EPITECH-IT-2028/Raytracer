...
TEST_F(ParserConfigFileTest, InvalidPlanesColorFields) {
  _cfgFile = "tests/primitives/planes/invalidFields/color/invalidColorR.cfg";
  ...
  _cfgFile = "tests/primitives/planes/invalidFields/color/invalidColorG.cfg";
  ...
  _cfgFile = "tests/primitives/planes/invalidFields/color/invalidColorB.cfg";
