...
TEST_F(ParserConfigFileTest, InvalidInfiniteCylindersColorFields) {
  _cfgFile = "tests/primitives/infiniteCylinders/invalidFields/color/invalidColorR.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/invalidFields/color/invalidColorG.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/invalidFields/color/invalidColorB.cfg";
