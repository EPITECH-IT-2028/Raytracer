...
TEST_F(ParserConfigFileTest, MissingInfiniteCylindersColorFields) {
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/color/missingColor.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/color/missingColorR.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/color/missingColorG.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/color/missingColorB.cfg";
