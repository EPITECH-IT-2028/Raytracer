...
TEST_F(ParserConfigFileTest, MissingInfiniteCylindersPositionFields) {
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/position/missingX.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/position/missingY.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/position/missingZ.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/missingFields/position/missingR.cfg";
