...
TEST_F(ParserConfigFileTest, ParseCylindersInfMaterials) {
  _cfgFile = "tests/primitives/infiniteCylinders/materials/reflective.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/materials/refractive.cfg";
  ...
  _cfgFile = "tests/primitives/infiniteCylinders/materials/transparent.cfg";
...
TEST_F(ParserConfigFileTest, ParseInvalidCylindersInfMaterial) {
  _cfgFile = "tests/primitives/infiniteCylinders/materials/invalid.cfg";
  Raytracer::ParserConfigFile parser(_cfgFile, _plugins);
  Raytracer::Camera camera;
  Raytracer::ShapeComposite sc;
  Raytracer::LightComposite lc;
