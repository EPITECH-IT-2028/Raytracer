...
TEST_F(ParserConfigFileTest, MissingConesPositionFields) {
  _cfgFile = "tests/primitives/cones/missingFields/position/missingX.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/position/missingY.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/position/missingZ.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/position/missingR.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/position/missingH.cfg";
