...
TEST_F(ParserConfigFileTest, MissingConesColorFields) {
  _cfgFile = "tests/primitives/cones/missingFields/color/missingColor.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/color/missingColorR.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/color/missingColorG.cfg";
  ...
  _cfgFile = "tests/primitives/cones/missingFields/color/missingColorB.cfg";
