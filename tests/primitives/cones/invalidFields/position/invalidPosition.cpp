...
TEST_F(ParserConfigFileTest, InvalidConesPositionFields) {
  _cfgFile = "tests/primitives/cones/invalidFields/position/invalidX.cfg";
  ...
  _cfgFile = "tests/primitives/cones/invalidFields/position/invalidY.cfg";
  ...
  _cfgFile = "tests/primitives/cones/invalidFields/position/invalidZ.cfg";
  ...
  _cfgFile = "tests/primitives/cones/invalidFields/position/invalidR.cfg";
  ...
  _cfgFile = "tests/primitives/cones/invalidFields/position/invalidH.cfg";
