...
TEST_F(ParserConfigFileTest, InvalidConesColorFields) {
  _cfgFile = "tests/primitives/cones/invalidFields/color/invalidColorR.cfg";
  ...
  _cfgFile = "tests/primitives/cones/invalidFields/color/invalidColorG.cfg";
  ...
  _cfgFile = "tests/primitives/cones/invalidFields/color/invalidColorB.cfg";
