...
namespace Raytracer {
   ...
   * object with a center (point on its axis), radius, normal vector (axis orientation),
   * and color.
   */
  class CylinderInf : public AShape {
    public:
       ...
       * Initializes an infinite cylinder with radius 1, centered at origin (0,0,0),
       ...
       * @param offset The vector by which to translate the cylinder's center point.
       */
