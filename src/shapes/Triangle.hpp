...
namespace Raytracer {
  ...
  class Triangle : public AShape {
    public:
       ...
       * @param center The center point of the triangle (often calculated as the
       * centroid).
      ...
      Triangle(const Math::Point3D &center, const Math::Point3D &p1,
          ...
          : _normal(normal), _p1(p1), _p2(p2), _p3(p3) {
        _center = center;
        _color = color;
      }
       ...
       * the triangle, and a pointer to the triangle itself if hit, otherwise a
       * zero distance and null pointer.
       */
       ...
       * @param point The point on the triangle's surface (unused, as triangle
       * has a constant normal).
       ...
       * This implementation only translates the center. For full triangle
       * translation, vertices p1, p2, and p3 should also be translated.
       ...
       */
      void setP1(const Math::Point3D &p1) {
        _p1 = p1;
      }
      /**
       ...
       */
      void setP2(const Math::Point3D &p2) {
        _p2 = p2;
      }
      /**
       ...
       */
      void setP3(const Math::Point3D &p3) {
        _p3 = p3;
      }
